...
![image-20250305102648324](/images/$%7Bfiilename%7D/image-20250305102648324.png)



判断下面的树是否为红黑树：

![img](/images/$%7Bfiilename%7D/e4d1a2c570c111ab54bf9c1e50ae1dc7.png)
...
![img](/images/$%7Bfiilename%7D/3b9b9575ae889320f8433770d5816728.png)
...
![在这里插入图片描述](/images/$%7Bfiilename%7D/a92615d27697083a5fde945db826d4c6.png)

将父节点和叔叔节点重新着色为黑色，将祖父节点重新着色为红色

![在这里插入图片描述](/images/$%7Bfiilename%7D/38056ee3706d3d58c1be433378a8bdb3.png)

将 **z** 指向祖父节点（将grandfather看作插入节点，修正上层颜色，而不是将插入节点覆盖到grandfather），继续检查上层节点，防止高层的性质被破坏。

![在这里插入图片描述](/images/$%7Bfiilename%7D/b07b8d3ea39d73da0da02b7ecf0c1685.png)
...
![image-20250305111224288](/images/$%7Bfiilename%7D/image-20250305111224288.png)

对祖父进行右旋

![image-20250305111249032](/images/$%7Bfiilename%7D/image-20250305111249032.png)

将父节点重新着色为黑色，祖父染色为红色

![image-20250305111317581](/images/$%7Bfiilename%7D/image-20250305111317581.png)

b）RR型：插入 40

![image-20250305112649259](/images/$%7Bfiilename%7D/image-20250305112649259.png)

对祖父左单旋

![image-20250305112802927](/images/$%7Bfiilename%7D/image-20250305112802927.png)

将祖父节点染红，父亲节点染黑

![image-20250305112834564](/images/$%7Bfiilename%7D/image-20250305112834564.png)

c）LR型：插入  23

![image-20250305113143751](/images/$%7Bfiilename%7D/image-20250305113143751.png)

对父节点进行左旋

![image-20250305113234523](/images/$%7Bfiilename%7D/image-20250305113234523.png)



对 25 进行右旋

![image-20250305113312437](/images/$%7Bfiilename%7D/image-20250305113312437.png)

将原本的祖父节点和插入节点颜色互换

![image-20250305113415565](/images/$%7Bfiilename%7D/image-20250305113415565.png)

d）RL型别：情况一处理完转到祖父节点后发现，23 是RL型别

![image-20250305113455307](/images/$%7Bfiilename%7D/image-20250305113455307.png)

对20进行右旋

![image-20250305113644076](/images/$%7Bfiilename%7D/image-20250305113644076.png)



对30进行左旋

![image-20250305113710280](/images/$%7Bfiilename%7D/image-20250305113710280.png)

30和23颜色互换

![image-20250305113748780](/images/$%7Bfiilename%7D/image-20250305113748780.png)
...
![在这里插入图片描述](/images/$%7Bfiilename%7D/c08cc7f28bd9f7983c1a6691674532ad.png)
...
![在这里插入图片描述](/images/$%7Bfiilename%7D/2f64b2058828919252abeface76b1b1a.png)
...
![在这里插入图片描述](/images/$%7Bfiilename%7D/37ab8fce93fa6dad68ed9fb506e03b74.png)
...
![在这里插入图片描述](/images/$%7Bfiilename%7D/4994276542272176a66124ccbb669f72.png)
...
![在这里插入图片描述](/images/$%7Bfiilename%7D/44cc4eb15ef0d9e6f8c9360c7a10f26b.png)
...
![在这里插入图片描述](/images/$%7Bfiilename%7D/04e159a6489003f099fb4921031491a3.png)
...
![在这里插入图片描述](/images/$%7Bfiilename%7D/6e443426f72f324305af90f01f4af42a.png)
